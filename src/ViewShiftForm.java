...
public class ViewShiftForm extends javax.swing.JFrame {

    /**
     * Creates new form ViewShiftForm
     */
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Start_Time", "End_Time", "Day", "Emp_ID", "Man_ID"
            }
        ));
...
try{
                String query="select distinct * from shift where emp_id=('"+EmployeeLogin.u+"')";
                Class.forName("java.sql.Driver");
                Connection con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/sruthi","root","1234");
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewShiftForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewShiftForm().setVisible(true);
            }
        });
    }
