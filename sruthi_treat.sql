...
CREATE TABLE `treat` (
  ...
  `ani_id` int(11) DEFAULT NULL,
  KEY `doc_id` (`doc_id`),
  KEY `ani_id` (`ani_id`),
  CONSTRAINT `treat_ibfk_1` FOREIGN KEY (`doc_id`) REFERENCES `doctor` (`doc_id`),
  CONSTRAINT `treat_ibfk_2` FOREIGN KEY (`ani_id`) REFERENCES `animal` (`ani_id`)
